...
python main.py -c configs/animal10N.json --traintools train_realworld --estimation_method growing_cluster --detection_method UNICON+K --train_noise_method ours --num_model 1 --seed 33636