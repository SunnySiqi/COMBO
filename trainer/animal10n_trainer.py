...
import dataloader.Animal10N as dataloader
...
class Animal10NTrainer(BaseTrainer):
    """
    ...
    def __init__(self, model, metrics, optimizer, config, parse, lr_scheduler=None, len_epoch=None):
        ...
        self.loader = dataloader.animal10N_dataloader(
            root, batch_size, warmup_batch_size, num_workers
        )
