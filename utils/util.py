...
def wandbRunlist(config, parse):
    ...
    wandb_run_name_list.append(str(config['data_loader']['noise']['type']))
    wandb_run_name_list.append(str(config['data_loader']['noise']['percent']))
    wandb_run_name_list.append(str(config['estimation']['method']))
    wandb_run_name_list.append(str(config['detection']['method']))
    wandb_run_name_list.append(str(config['trainer']['train_noise_method']))
